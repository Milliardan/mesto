class Card {
  ...
  generateCard() {
    ...
    this._cardElementPhoto = this.cardElement.querySelector('.elements__pic');
    this._cardElementLike = this.cardElement.querySelector('.elements__like');
    this._cardElementDel = this.cardElement.querySelector('.elements__remove');
    this._cardElementLikesCount = this.cardElement.querySelector('.elements__span');
